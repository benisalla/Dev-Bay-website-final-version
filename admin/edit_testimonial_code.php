<?php
    ...
    if(isset($_POST['save_btn'])){
        ...
        if($body === ''){
            $_SESSION['message'] = [
                'content' => 'fill in the testimonial !!',
                'type' => 'alert',
            ];
            echo "<script type='text/javascript'>  window.location='./edit_testimonial.php?id=".$id."'; </script>";
            exit(0);
        }

        $Query =  "update testimonial set user_id='$auther_id', state='$state', body='$body',
