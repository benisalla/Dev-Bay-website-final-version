...
$Query = "select count(*) as numOfRows from email where state = '0'";
        ...
        <div class="panel-body">
            <table class="table table-hover mails">
                <tbody>
                    ...
                    $Query = "select * from email where state = '0' ORDER by id desc LIMIT $num_rows";
                    $Result = mysqli_query($connection, $Query);
                    if (mysqli_num_rows($Result) > 0) :
            ...
            <div class="d-flex flex-row justify-content-between align-items-center mb-2">
                ...
                <div>
                    ...
                    <input type="hidden" id="fileName" value="fetchData_unseen_requests.php">
                </div>
            </div>
        </div>
    </div>
