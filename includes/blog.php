...
<div class="container-fluid  wow fadeInUp" data-wow-delay="0.1s" id="blog">
        ...
        <div class="row g-5">
            ...
            if (mysqli_num_rows($postResult) > 0) :
                ...
                foreach ($postResult as $post) : 
                    ...
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="<?= $i ?>s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/blog/<?= $post['image']; ?>" alt="">
                            ...
                            <div class="p-4">
                                <div class="d-flex mb-3">
                                    ...
                                    <small><i class="far fa-calendar-alt text-primary me-2"></i>
                                        <?php 
                                            $date = DateTime::createFromFormat('Y-m-d',$post['created_at']);
