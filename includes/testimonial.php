...
<div id="testimonial" class="container-fluid  wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
            ...
            <?php
            $testimonialQuery = "select * from testimonial where state = '1' ";
            $testimonialResult = mysqli_query($connection, $testimonialQuery);
            ...
            if (mysqli_num_rows($testimonialResult) > 0) :
                foreach ($testimonialResult as $testimonial) : ?>
                    ...
                    <div class="testimonial-item bg-light my-4">
                        ...
                        <?php else : ?>
                            <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                                <img class="img-fluid rounded" src="./img/users/profile.png" style="width: 60px; height: 60px;">
                                <div class="ps-4">
