...
if (isset($_POST['msg'])) :
    ...
    $query = "INSERT INTO comment (author_id, post_id, body) VALUES ('$author_id','$post_id','$body')";
        ...
        if (mysqli_num_rows($commentResult) > 0) :
            ...
            <div class="d-flex flex-row justify-content-between align-items-center my-2">
                ...
                <div class="show_more_comment">
                    <p class="<?= $allRows_comment <= 3 ? '' : 'display_more_comment' ?>  btn btn-dark text-light" id="<?= $post_id ?>">
